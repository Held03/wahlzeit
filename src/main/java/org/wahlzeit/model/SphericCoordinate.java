...
public class SphericCoordinate implements Coordinate {
	...
	public static final CartesianCoordinate ZENITH = new CartesianCoordinate(0.0, 1.0, 0.0);
	public static final CartesianCoordinate AZIMUTH = new CartesianCoordinate(1.0, 0.0, 0.0);
